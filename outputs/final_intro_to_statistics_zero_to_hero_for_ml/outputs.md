# Outputs: final_intro_to_statistics_zero_to_hero_for_ml
...
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97873/377210639.py:46: RuntimeWarning: invalid value encountered in matmul
  p    = 1.0 / (1.0 + np.exp(-Z @ w))                 # predicted P(y=1)
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97873/377210639.py:47: RuntimeWarning: divide by zero encountered in matmul
  grad = Z.T @ (p - y) / len(y) + l2 * np.r_[0.0, w[1:]]
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97873/377210639.py:47: RuntimeWarning: overflow encountered in matmul
  grad = Z.T @ (p - y) / len(y) + l2 * np.r_[0.0, w[1:]]
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97873/377210639.py:47: RuntimeWarning: invalid value encountered in matmul
  grad = Z.T @ (p - y) / len(y) + l2 * np.r_[0.0, w[1:]]
```
