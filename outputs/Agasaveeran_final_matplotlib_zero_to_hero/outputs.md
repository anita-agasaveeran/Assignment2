# Outputs: Agasaveeran_final_matplotlib_zero_to_hero
...
![cell 5](figures/cell005_0.png)

```text
<Figure size 900x280 with 1 Axes>
```

![cell 5](figures/cell005_1.png)
...
![cell 6](figures/cell006_1.png)

```text
<Figure size 700x220 with 1 Axes>
```

![cell 6](figures/cell006_2.png)
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97808/2318283478.py:49: RuntimeWarning: divide by zero encountered in matmul
  S3_LUM = rgba[..., :3] @ np.array([0.2126, 0.7152, 0.0722])   # ITU-R BT.709
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97808/2318283478.py:49: RuntimeWarning: overflow encountered in matmul
  S3_LUM = rgba[..., :3] @ np.array([0.2126, 0.7152, 0.0722])   # ITU-R BT.709
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97808/2318283478.py:49: RuntimeWarning: invalid value encountered in matmul
  S3_LUM = rgba[..., :3] @ np.array([0.2126, 0.7152, 0.0722])   # ITU-R BT.709
```
...
![cell 44](figures/cell044_0.png)

```text
<Figure size 900x420 with 1 Axes>
```

![cell 44](figures/cell044_1.png)
...
![cell 46](figures/cell046_0.png)

```text
<Figure size 900x420 with 1 Axes>
```

![cell 46](figures/cell046_1.png)
...
![cell 48](figures/cell048_0.png)

```text
<Figure size 1020x500 with 1 Axes>
```

![cell 48](figures/cell048_1.png)
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97808/925649531.py:37: RuntimeWarning: divide by zero encountered in matmul
  Y = lin @ np.array([0.2126, 0.7152, 0.0722])
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97808/925649531.py:37: RuntimeWarning: overflow encountered in matmul
  Y = lin @ np.array([0.2126, 0.7152, 0.0722])
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97808/925649531.py:37: RuntimeWarning: invalid value encountered in matmul
  Y = lin @ np.array([0.2126, 0.7152, 0.0722])
```
...
```text
scratch dir : /var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/mpl_part8_hoebjsf_
...
----------------------------------------------------------
   6.4 x  4.8   100    640 x480       640 x480        32.4
   6.4 x  4.8   200   1280 x960      1280 x960        75.6
```

```text
   6.4 x  4.8   300   1920 x1440     1920 x1440      122.7
   3.2 x  2.4   200    640 x480       640 x480        36.6
  12.8 x  9.6    50    640 x480       640 x480        22.1
...
```text
plain savefig                 900 x600       6.00 x4.00      54.7
```

```text
bbox_inches='tight'           814 x586       5.43 x3.91      53.7
tight, pad_inches=0           784 x556       5.23 x3.71      52.8
tight, pad_inches=0.5         934 x706       6.23 x4.71      56.3
...
```text
big    figsize=8.00 x 6.00 in   1600 x 1200 px   tick label height = 10.08 pt   91 KB
```

```text
small  figsize=3.25 x 2.44 in   650 x 487 px   tick label height = 10.08 pt   37 KB
...
```text
default type  -> 650 x 487 px, tick label 10.08 pt, 37.1 KB
PUB type      -> 650 x 487 px, tick label 6.84 pt, 35.8 KB
```
...
```text
line chart             png             46.2          0.02
line chart             svg             29.4          0.02
```

```text
line chart             pdf             13.5          0.20
```

```text
scatter, 100,000 pts   png            170.1          0.21
```

```text
scatter, 100,000 pts   svg         15,711.8          1.00
```

```text
scatter, 100,000 pts   pdf          1,493.6          1.01

line chart : SVG is 0.64x the PNG (29.4 KB vs 46.2 KB)
dense scatter: SVG is 92x the PNG (15.3 MB vs 170.1 KB)
...
```text
findfont: Font family ['A Font That Does Not Exist'] not found. Falling back to DejaVu Sans.
```

```text
font families matplotlib can see here: 441
first 12: .Aqua Kana, .CJK Symbols Fallback HK, .DecoType Nastaleeq Urdu UI, .Keyboard, .New York, .SF Arabic, .SF Arabic Rounded, .SF Armenian, .SF Armenian Rounded, .SF Camera, .SF Compact, .SF Compact Rounded
...
got       : 975 x 720 px  (3.25 x 2.40 in at 300 dpi),  58 KB
match     : True
...
metadata  : Software     = matplotlib 3.10.9

scratch dir held 25 files, 17.9 MB total -- removed.
still exists: False
```
