# Outputs: Agasaveeran_final_intro_to_linear_algebra_zero_to_hero_for_ml
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97779/2099211114.py:10: RuntimeWarning: divide by zero encountered in matmul
  dots    = sweep @ b_fixed                                # one dot product each
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97779/2099211114.py:10: RuntimeWarning: overflow encountered in matmul
  dots    = sweep @ b_fixed                                # one dot product each
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97779/2099211114.py:10: RuntimeWarning: invalid value encountered in matmul
  dots    = sweep @ b_fixed                                # one dot product each
```
...
column means AFTER  centring: [2.949e-15 1.903e-15]   <- not rounded
are they zero?  True
largest surviving mean = 2.949e-15  (floating-point dust)
...
```text
associativity   (PQ)T vs P(QT) : max difference 8.88e-16
                same shape?      True -> (3, 5)
...
60 random points, pushed through B then A, vs through the product A@B:
  largest difference over all 120 coordinates: 4.44e-16
...
loop  over 200 flowers:      143.9 microseconds
one matrix multiplication:        3.2 microseconds
SPEEDUP:                         44.6 x
```
...
same outputs?               True
largest disagreement:       3.553e-15
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97779/2400817755.py:73: RuntimeWarning: divide by zero encountered in matmul
  spread = np.var(Xc @ dirs.T, axis=0, ddof=1)         # variance along each direction
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97779/2400817755.py:73: RuntimeWarning: overflow encountered in matmul
  spread = np.var(Xc @ dirs.T, axis=0, ddof=1)         # variance along each direction
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97779/2400817755.py:73: RuntimeWarning: invalid value encountered in matmul
  spread = np.var(Xc @ dirs.T, axis=0, ddof=1)         # variance along each direction
```
...
IS THE EIGENVALUE THE VARIANCE ALONG THAT DIRECTION?
  ...
  covariance of the two score sets = 1.116e-18  (zero: PCA de-correlated the data)
...
```text
  ...
  largest score disagreement        : 4.619e-14
