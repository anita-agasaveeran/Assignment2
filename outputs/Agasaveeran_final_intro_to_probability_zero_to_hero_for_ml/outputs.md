# Outputs: Agasaveeran_final_intro_to_probability_zero_to_hero_for_ml
...
```text
/Users/anitaagasaveeran/Desktop/MSSE_Fall2026/CMPE255/Assignment2/.venv/lib/python3.12/site-packages/numpy/_core/fromnumeric.py:3860: RuntimeWarning: Mean of empty slice.
...
```text
  ...
  loose: average deviation E[X - mu] = +8.61e-16   (and mean |deviation| = 9.566)
...
Binomial(10, 0.3) PMF
  ...
  0   0.02824752   0.02824752      3.12e-17
  1   0.12106082   0.12106082      0.00e+00
  2   0.23347444   0.23347444      3.61e-16
  3   0.26682793   0.26682793      0.00e+00
  4   0.20012095   0.20012095      5.55e-17
  5   0.10291935   0.10291935      0.00e+00
largest difference over all 11 values: 3.61e-16
...
correlation: largest - smallest = 3.33e-16
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97798/3464884975.py:17: RuntimeWarning: divide by zero encountered in matmul
  s = (np.log(prior)     + Xq @ np.log(p_spam_w) + (1 - Xq) @ np.log(1 - p_spam_w))
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97798/3464884975.py:17: RuntimeWarning: overflow encountered in matmul
  s = (np.log(prior)     + Xq @ np.log(p_spam_w) + (1 - Xq) @ np.log(1 - p_spam_w))
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97798/3464884975.py:17: RuntimeWarning: invalid value encountered in matmul
  s = (np.log(prior)     + Xq @ np.log(p_spam_w) + (1 - Xq) @ np.log(1 - p_spam_w))
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97798/3464884975.py:18: RuntimeWarning: divide by zero encountered in matmul
  h = (np.log(1 - prior) + Xq @ np.log(p_ham_w)  + (1 - Xq) @ np.log(1 - p_ham_w))
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97798/3464884975.py:18: RuntimeWarning: overflow encountered in matmul
  h = (np.log(1 - prior) + Xq @ np.log(p_ham_w)  + (1 - Xq) @ np.log(1 - p_ham_w))
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97798/3464884975.py:18: RuntimeWarning: invalid value encountered in matmul
  h = (np.log(1 - prior) + Xq @ np.log(p_ham_w)  + (1 - Xq) @ np.log(1 - p_ham_w))
```
...
UNSMOOTHED
    log-score for spam       = -10.721026318885592
