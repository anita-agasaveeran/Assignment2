# Outputs: Agasaveeran_final_pandas_zero_to_hero
...
[819, 160, 104, 769, 680, 681, 256, 52]
...
```text
mask   0.11 ms      query  0.61 ms      query is 5.6x SLOWER on 914 rows
```
...
for + iterrows         7.279    378.934
 apply(axis=1)         1.669     86.867
    vectorised         0.019      1.000
...
this frame   894        0.084         0.263     3.133
x80 copies 71520        5.006        14.503     2.897
```
...
ISO '2024-03-14'        no format=    0.153                 1.427
ISO '2024-03-14' format='%Y-%m-%d'    0.107                 1.000
   '14 Mar 2024'        no format=    0.734                 1.111
   '14 Mar 2024' format='%d %b %Y'    0.660                 1.000
   '14 Mar 2024'    format='mixed'   10.284                15.573
...
```text
DataFrameGroupBy
<pandas.core.groupby.generic.DataFrameGroupBy object at 0x11c6adbe0>
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/438475291.py:7: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  by_two = tidy.groupby(["region", "category"])["revenue"].sum()
```
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1277281781.py:2: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  per_band = tidy.groupby("rating_band")["revenue"].sum()
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1277281781.py:6: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  n_group = tidy.groupby("rating_band").size().sum()
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1277281781.py:21: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  print(tidy.groupby("rating_band", dropna=False)["revenue"].sum())
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1277281781.py:23: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  f"{tidy.groupby('rating_band', dropna=False)['revenue'].sum().sum():,.2f}"
```
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1994470378.py:3: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  print(tidy.groupby("region")["revenue"].agg(["sum", "mean", "count"]), "\n")
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1994470378.py:7: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  print(tidy.groupby("region").agg({"revenue": "sum",
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1994470378.py:12: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  report = tidy.groupby("region").agg(
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1994470378.py:25: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  print(tidy.groupby("region")["revenue"].agg(
```
...
over 30 groups:
   .sum()                       0.15 ms
   .apply(lambda s: s.sum())    0.46 ms   (3.0x slower, for identical arithmetic)
```
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1901473864.py:3: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  .groupby(["region", "product"], dropna=False)        # split on both keys
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/1901473864.py:9: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  .groupby("region", dropna=False)          # within each region...
```
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/250198065.py:6: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  .groupby(["region", "product"])["revenue"].sum()
```
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/3203797608.py:8: FutureWarning: The default value of observed=False is deprecated and will change to observed=True in a future version of pandas. Specify observed=False to silence this warning and retain the current behavior
  grid_tot = txn.pivot_table(index="store", columns="category", values="revenue",
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/3203797608.py:18: FutureWarning: The default value of observed=False is deprecated and will change to observed=True in a future version of pandas. Specify observed=False to silence this warning and retain the current behavior
  multi = txn.pivot_table(index="region", columns="category",
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/3203797608.py:18: FutureWarning: The default value of observed=False is deprecated and will change to observed=True in a future version of pandas. Specify observed=False to silence this warning and retain the current behavior
  multi = txn.pivot_table(index="region", columns="category",
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/3203797608.py:24: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
  n_pairs = txn.groupby(["store", "category"]).ngroups
```
...
```text
/var/folders/mz/9z30xzjs3sd9h00px0g18mqr0000gn/T/ipykernel_97840/4170237732.py:3: FutureWarning: The default value of observed=False is deprecated and will change to observed=True in a future version of pandas. Specify observed=False to silence this warning and retain the current behavior
  p9_monthly    = tidy.pivot_table(index=pd.Grouper(key="date", freq="ME"),
```
...
![cell 84](figures/cell084_0.png)

```text
<Figure size 900x900 with 16 Axes>
```

![cell 84](figures/cell084_1.png)
...
894 rows; all three produce identical output
  ...
  np.select  (vectorised)     0.073 ms
  .apply(axis=1)              2.046 ms
  .iterrows() loop            7.753 ms

  vectorised vs .apply(axis=1) :   27.9x faster
  vectorised vs .iterrows()    :  105.9x faster

per row: the loop costs   8.67 microseconds, np.select costs 0.082
```
...
benchmark frame: 357,600 rows x 3 columns
  ...
  arithmetic, 3 temporaries        0.54 ms
    the same via .eval()           0.85 ms   ->  0.64x
  3-condition boolean mask         0.68 ms
    the same via .query()          1.07 ms   ->  0.63x

VERDICT on THIS runtime: .eval() is SLOWER than plain arithmetic (0.64x).
